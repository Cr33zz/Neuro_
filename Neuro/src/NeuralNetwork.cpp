...
//
//            vector<Data> batchedTrainingData = trainingDataAlreadyBatched ? trainingData : MergeData(trainingData, batchSize);
//
//            float trainTotalError = 0;
//            int trainHits = 0;
//
...
//                if (verbose == 2)
//                {
//                    output = GetProgressString(b * batchSize + samples, totalTrainingSamples);
...
//            if (verbose == 2)
//            {
//                output = GetProgressString(totalTrainingSamples, totalTrainingSamples);
//                LogLine(output);
//            }
//
