...
{
    //////////////////////////////////////////////////////////////////////////
    BatchNorm::BatchNorm(LayerBase* inputLayer, const string& name)
        : LayerBase(__FUNCTION__, inputLayer, inputLayer->OutputShape(), nullptr, name)
    {
    }

    //////////////////////////////////////////////////////////////////////////
    BatchNorm::BatchNorm(const Shape& inputShape, const string& name)
    ...
    //////////////////////////////////////////////////////////////////////////
    void BatchNorm::CopyParametersTo(LayerBase& target, float tau) const
    {
        __super::CopyParametersTo(target, tau);

        auto& targetBatchNorm = static_cast<BatchNorm&>(target);
        m_Gamma.CopyTo(targetBatchNorm.m_Gamma, tau);
        m_Beta.CopyTo(targetBatchNorm.m_Beta, tau);
    }

    //////////////////////////////////////////////////////////////////////////
    int BatchNorm::GetParamsNum() const
    {
        return m_Gamma.Length() + m_Beta.Length();
    }

    //////////////////////////////////////////////////////////////////////////
    void BatchNorm::GetParametersAndGradients(vector<ParametersAndGradients>& result)
    {
    ...
    //////////////////////////////////////////////////////////////////////////
    LayerBase* BatchNorm::GetCloneInstance() const
    {
        return new BatchNorm();
    }

    //////////////////////////////////////////////////////////////////////////
    void BatchNorm::OnInit()
    {
        __super::OnInit();
    ...
    //////////////////////////////////////////////////////////////////////////
    void BatchNorm::FeedForwardInternal(bool training)
    {
        if (training)
        {
    ...
    //////////////////////////////////////////////////////////////////////////
    void BatchNorm::BackPropInternal(Tensor& outputGradient)
    {
