...
namespace Neuro
{
	...
	struct CudaKernels
	{
        ...
        static void Inverse(const dim3& blocks, const dim3& threads, int inputLen, const float* inputDev, float alpha, float* outputDev, int subLen);
        ...
        static void Div(const dim3& blocks, const dim3& threads, int len, float alpha, const float* t1, float beta, const float* t2, float* outputDev, int subLen);
