...
namespace Neuro
{
	...
	public:
        ...
        virtual void Pool2D(const Tensor& input, int filterSize, int stride, EPoolingMode type, int paddingX, int paddingY, Tensor& output) const;
        ...
        virtual void UpSample2D(const Tensor& input, int scaleFactor, Tensor& output) const;
        virtual void UpSample2DGradient(const Tensor& outputGradient, int scaleFactor, Tensor& inputGradient) const;
