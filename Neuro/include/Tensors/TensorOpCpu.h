...
namespace Neuro
{
	...
	public:
        ...
        virtual void Transpose(const Tensor& t, Tensor& result);
        ...
        virtual void Conv2DGradient_old(const Tensor& input, const Tensor& kernels, const Tensor& outputGradient, int stride, int paddingX, int paddingY, Tensor& inputGradient, Tensor& kernelsGradient);
        ...
        virtual void SumBatches(const Tensor& t, Tensor& result);
