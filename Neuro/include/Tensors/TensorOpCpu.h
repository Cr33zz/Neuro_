...
namespace Neuro
{
	...
	public:
        ...
        virtual void Conv2DGradient_old(const Tensor& input, const Tensor& kernels, const Tensor& outputGradient, int stride, int paddingX, int paddingY, Tensor& inputGradient, Tensor& kernelsGradient) const;
