...
namespace Neuro
{
	...
	public:
        ...
        void FeedForward(Tensor[] inputs)
        {
            Model.FeedForward(inputs);
        }
	...
	public:    
        ...
        void FitBatched(List<Tensor> inputs, List<Tensor> outputs, int epochs = 1, int verbose = 1, Track trackFlags = Track.TrainError | Track.TestAccuracy, bool shuffle = true)
        {
        ...
        void Fit(List<Tensor[]> inputs, List<Tensor[]> outputs, int batchSize = -1, int epochs = 1, int verbose = 1, Track trackFlags = Track.TrainError | Track.TestAccuracy, bool shuffle = true)
        {
        ...
        void Fit(Tensor[] inputs, Tensor[] outputs, int batchSize = -1, int epochs = 1, int verbose = 1, Track trackFlags = Track.TrainError | Track.TestAccuracy, bool shuffle = true)
        {
        ...
        void Fit(List<Data> trainingData, int batchSize = -1, int epochs = 1, List<Data> validationData = null, int verbose = 1, Track trackFlags = Track.TrainError | Track.TestAccuracy, bool shuffle = true)
        {
	...
	private:
        ...
        int Seed;
        typedef int (AccuracyFunc*)(const Tensor& targetOutput, Tensor& output);
        AccuracyFunc[] AccuracyFuncs;
